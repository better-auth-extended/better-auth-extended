...
export const LegalConsentOffer = () => {
	...
	return (
		...
		>
			<motion.div
				className={cn(
					"w-full h-[400px] rounded-2xl bg-card border border-border py-5 px-2 absolute inset-0 drop-shadow-lg",
				)}
				animate={
					isHovering
						? { y: -220, scale: 0.9 }
...
function CheckboxIndicator({ isHovering }: { isHovering: boolean }) {
	...
	return (
		<button type="button" tabIndex={-1} className="relative flex items-center">
			<input
				type="checkbox"
